    ...
    <div className={styles.container}>
      ...
      <div className={styles.item}>
        ...
        <div className={styles.info}>
          ...
          <p>
            ...
            admitted to their faults. People are giving up their autonomy. Both
            social media (Twitter, Facebook) do things to maximize "stickiness".
          </p>
        </div>
      </div>
      <div className={styles.item}>
        <div className={styles.info}>
          ...
          <p>
            ...
            extending a "Common Share" of token ownership. Users will have their
            own beautiful space with AI support. + copyright protection for user
            content.
          </p>
        </div>
      ...
      <div className={styles.item}>
        ...
        <div className={styles.info}>
          ...
          <p>
            It will offer a better-designed and uncluttered space for users plus
            tools to help realize self-expression, communication and
            collaboration. Privacy invasion, data mining and ad push won’t be
            features + granular customizability, full user control over ad-push
            and data sharing plus user designated communities.
          </p>
        </div>
      </div>
