  ...
  <div className={styles.container}>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Common Innovations Inc, 5-42 Northview Rd,
          Nepean ON, K2E7E4.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Our Common Share, accessible from{" "}
          <a
            href="Http://www.ourcommonshare.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            Http://www.ourcommonshare.com
          </a>
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        ...
        <a
          href="Http://www.ourcommonshare.com/contact"
          rel="external nofollow noopener"
          target="_blank"
        >
          Http://www.ourcommonshare.com/contact
        </a>
      </li>
    </ul>
  </div>
